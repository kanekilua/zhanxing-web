...
export default {
    ...
    methods: {
        ...
        initPage() {
            ...
            if(index === 0) {
                index = this.$route.path === '/main/fortune/todayFortune' ? 0 : this.$route.path === '/main/fortune/monthFortune' ? 1 : this.$route.path === '/main/fortune/yearFortune' ? 2 : 0;
                this.udpateNowIndex(index);
            }
